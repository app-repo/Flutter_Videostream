...
// The size of the plus icon under the profile image in follow action
  ...
  ActionsToolbar(this.numLikes, this.numComments, this.userPic,this.numshare);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        _followAction(pictureUrl: userPic),
        _getSocialIcons(icon: TikTokIcons.heart, title: numLikes),
        _getSocialIcons(icon: TikTokIcons.chat_bubble, title: numComments),
        _getSocialIcons(
            icon: TikTokIcons.reply, title: numshare, isShare: true),
        CircleImageAnimation(
          child: _MusicPlayercircle(userPic),
        )
  ...
  Widget _getSocialIcons({String title, IconData icon, bool isShare = false}) {
    return Container(
  ...
  Widget _followAction({String pictureUrl}) {
    return Container(
...
//animated icon
  Widget _MusicPlayercircle(userPic) {
    return Container(
